...
public final class DroppersGroup extends ChestEspBlockGroup
{
	public DroppersGroup(ConfigHolder<ChestEspConfig> ch)
	{
		super(ch, "dropper");
	}
	...
	{
		return c.include_droppers;
	}
	
	@Override
	protected int getColor(ChestEspConfig c)
	{
		return c.dropper_color;
	}
	
	@Override
	protected boolean matches(BlockEntity be)
	{
		return be instanceof DropperBlockEntity;
	}
}
