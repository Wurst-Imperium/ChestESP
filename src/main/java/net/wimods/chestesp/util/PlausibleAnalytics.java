...
public final class PlausibleAnalytics
{
	...
	public void onWorldChange(MinecraftClient client, ClientWorld world)
	{
		...
		String path = getPathForServer(client, client.getCurrentServerEntry());
	...
	private String getPathForServer(MinecraftClient client, ServerInfo server)
	{
		if(server == null)
			return "/singleplayer";
		if(server.isLocal())
