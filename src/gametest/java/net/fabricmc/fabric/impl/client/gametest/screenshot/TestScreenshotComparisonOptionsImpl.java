	...
	implements TestScreenshotComparisonOptions
{
	...
	{
		// Changed to use Class.getResourceAsStream() since we don't have
		// the helper methods from Fabric Loader in NeoForge.
		String resourcePath = "/templates/" + templateImagePath + ".png";
		
		try(InputStream stream = TestScreenshotComparisonOptionsImpl.class
